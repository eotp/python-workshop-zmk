...
> _Note that if you want to run this repo in [JuptyerLab](https://github.com/jupyterlab/jupyterlab) on binder follow this link: [binder jupyterlab](https://mybinder.org/v2/gh/eotp/python-workshop-zmk/master?urlpath=lab)_
